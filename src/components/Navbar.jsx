...
import searhicon from "../assets/images/search.svg";
      ...
      <div className="container">
        <div className="flex justify-between flex-wrap">
          <div className="flex flex-wrap items-center gap-4 md:gap-36">
            ...
            <div className="border-[1px] border-gray py-2 px-3 rounded-full">
              <form
                action=""
                className="flex flex-col md:flex-row gap-2 md:gap-28"
              >
                <div className="flex gap-4">
                  <img src={searhicon} alt="" />
                  <input
                    className="border-none outline-none py-2 md:py-0"
                    type="text"
                    name=""
                    id=""
